...
//         <nav
//           ref={menuRef}
//           className={`absolute md:static top-[60px] right-0 w-[250px] md:w-auto md:flex md:items-center 
//           bg-white md:bg-transparent shadow-md md:shadow-none transition-all duration-300 h-screen md:h-auto flex flex-col items center justify-center ${
//             isMenuOpen ? "block" : "hidden"
//           }`}
//         >
//           <ul className="flex flex-col md:flex-row md:gap-4 text-textColor p-2 md:p-0">
...
//               <Link to="/login" >
//                 <button className="bg-primaryColor py-2 px-6 text-white font-[600] rounded-[50px] w-full text-center">
//                   Login
//                 </button>
//               </Link>
//               </li>
