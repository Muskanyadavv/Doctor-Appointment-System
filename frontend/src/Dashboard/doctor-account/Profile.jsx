...
const Profile = ({ doctorData }) => {
  ...
  const addQualification = (e) => {
    ...
    addItem("qualifications", {
      ...
      endingDate: "",
      degree: "PHD",
      univeristy: "Dhaka Medical College",
    });
  };
            ...
            <div key={index}>
              <div>
                ...
                <button
                  ...
                  className="bg-red-600 rounded-full text-white text-[18px] mt-2 mb-[30px]
              cursor-pointer"
                >
                  <AiOutlineDelete />
                </button>
            ...
            <div key={index}>
              <div>
                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                  ...
                  >
                    <button className="bg-red-600 rounded-full text-white text-[18px] cursor-pointer mt-6">
                      <AiOutlineDelete />
                    </button>
                  </div>
                </div>
