  ...
  return (
    <section>
      <div className="max-w-[1170] px-5 mx-auto">
        ...
        {!loading && !error && data && (
          <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[100px]">
          <Tabs tab={tab} setTab={setTab} doctorData={data} />
            ...
            1 0 100-2v-3a1 1 0 00-1-1H9z"
                  ...
                  <div className="ml-3 text-sm font-medium">
                    To get approval please complete youe profile. We&apos;ll
              ...
              <div className="mt-8">
                {tab === "overview" && (
                  <div>
                    <div className="flex items-center gap-10 mb-10">
                      <figure className=" max-w-[100px] max-h-[250px]">
               ...
               text-[12px]  leading-4 lg:text-[20px] lg:leading-6 font-semibold"
                        >
                          {data.specialization}
                        </span>
                ...
                leading-5 lg:text-[16px] lg:leading-6 font-semibold"
                        ...
                        <p className="text__para font-[15px] lg:max-w-[200px] leading-6">
                          {data?.bio}
                        </p>
                      </div>
                    </div>
